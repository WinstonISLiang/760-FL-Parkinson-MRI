...
data_path = os.path.join(base_dir, "client_data1", "client_1")
...
client = ParkinsonClient(model, train_loader, test_loader, device, client_id=1, seed=123)
client.peer_seeds = [456]
